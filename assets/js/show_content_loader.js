// const show_references = document.getElementsByClassName('main-content')[0].id
// const show_type = show_references.split('-')[0]
// const show_id = show_references.split('-')[1]
